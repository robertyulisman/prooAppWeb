...
const TOS = (props) => {
  return (
    <div className="mt-10 mb-5 md:container items-center text-justify space-y-5">
      <div className="title">
        <p className="text-xl text-center font-bold">Terms Of Service</p>
      </div>
      <div className="long-text bg-white p-10 px-16 w-3/4 mx-auto rounded-2xl">
        <p>
          <b>PT. Asia Proo Teknologi</b> built the Proo app as a Free app. This
          SERVICE is provided by <b>PT. Asia Proo Teknologi</b> at no cost and
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at Proo unless otherwise
        ...
        <p>
          ...
          <a href="mailto:proo.official20@gmail.com" className="text-green-500">
